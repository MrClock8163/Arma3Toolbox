...
class A3OB_PT_proxies(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        col_align.operator("a3ob.proxy_align", icon_value=AddonInfo.get_icon("op_proxy_align"))
        col_align.operator("a3ob.proxy_align_object", icon_value=AddonInfo.get_icon("op_proxy_align_object"))
        layout.operator("a3ob.proxy_realign_ocs", icon_value=AddonInfo.get_icon("op_proxy_realign"))
        layout.operator("a3ob.proxy_extract", icon_value=AddonInfo.get_icon("op_proxy_extract"))
        col_move = layout.column(align=True)
        col_move.operator("a3ob.proxy_copy", icon_value=AddonInfo.get_icon("op_proxy_copy"))
        col_move.operator("a3ob.proxy_copy_all", icon_value=AddonInfo.get_icon("op_proxy_copy_all"))
        col_move.operator("a3ob.proxy_transfer", icon_value=AddonInfo.get_icon("op_proxy_transfer"))
