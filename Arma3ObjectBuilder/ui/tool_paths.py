...
class A3OB_PT_renaming_paths_bulk(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row_filter.operator("a3ob.rename_list_refresh", text="", icon_value=AddonInfo.get_icon("op_refresh"))
        ...
        if utils.is_valid_idx(scene_props.path_list_index, scene_props.path_list):
            ...
            col_edit.separator()
            col_edit.operator("a3ob.rename_path_item", icon_value=AddonInfo.get_icon("op_replace"))
...
class A3OB_PT_renaming_paths_root(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.operator("a3ob.rename_path_root", icon_value=AddonInfo.get_icon("op_replace"))
...
class A3OB_PT_renaming_vertex_groups(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.operator("a3ob.rename_vertex_groups", icon_value=AddonInfo.get_icon("op_replace"))
